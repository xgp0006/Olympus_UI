...
<div class="weather-controls">
  <div class="layers-section">
    ...
    <div class="layer-toggle">
      <label>
        <input type="checkbox" checked={layers.radar} on:change={() => toggleLayer('radar')} />
    ...
    <div class="layer-toggle">
      <label>
        <input type="checkbox" checked={layers.wind} on:change={() => toggleLayer('wind')} />
  ...
  <div class="auto-update-section">
    <label class="toggle-label">
      <input type="checkbox" bind:checked={autoUpdate} on:change={updateSettings} />
      Auto-update
    </label>
    ...
    {#if autoUpdate}
      <div class="update-interval">
        ...
        <select id="update-interval" bind:value={updateInterval} on:change={updateSettings}>
