...
<div class="stage-controls">
	{#each [SafetyStage.STAGE_1, SafetyStage.STAGE_2, SafetyStage.STAGE_3, SafetyStage.STAGE_4] as stage}
		<button
			...
			on:touchcancel={() => { gestureInProgress = false; if (gestureTimer) clearTimeout(gestureTimer); }}
		>
...
<style>
	...
	@keyframes emergency-pulse {
		0%, 100% { background: var(--color-status_error); }
		50% { background: var(--color-status_warning); }
	}
