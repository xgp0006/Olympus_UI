...
<script lang="ts">
	...
	$: responseColor = maxResponseTime < 0.5 ? 'var(--color-status_success)' :
	                  maxResponseTime < 1.0 ? 'var(--color-status_warning)' :
...
<div class="safety-metrics">
	...
	{#if violations > 0}
		<div class="warning-banner">
			⚠️ Emergency stop response time violations detected!
		</div>
	{/if}
</div>
