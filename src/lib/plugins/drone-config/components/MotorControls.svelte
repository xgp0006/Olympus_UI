...
<div class="motor-controls">
  ...
  <div class="control-buttons">
    <button class="test-button" on:click={onRunDirectionTest} disabled={!canTest || testActive}>
      Direction Test
    </button>
    <button class="test-button" on:click={onRunRampTest} disabled={!canTest || testActive}>
      Ramp Test
    </button>
    <button class="test-button stop" on:click={() => onSetAllMotorsThrottle(0)} disabled={!canTest}>
      Stop All
    </button>
    <button class="test-button emergency" on:click={emergencyStop} title="Emergency Stop (ESC key)">
      ⚠ E-STOP
    </button>
  </div>
