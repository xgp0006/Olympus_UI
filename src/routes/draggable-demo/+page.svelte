...
<style>
  ...
  .header {
    position: fixed;
    top: calc(var(--layout-spacing_unit) * 2.5);
    left: calc(var(--layout-spacing_unit) * 2.5);
    z-index: 100;
    pointer-events: none;
  }

  .header h1 {
    font-size: var(--typography-font_size_2xl, 28px);
  ...
  .performance-overlay {
    position: fixed;
    top: calc(var(--layout-spacing_unit) * 2.5);
    right: calc(var(--layout-spacing_unit) * 2.5);
  ...
  .performance-overlay .metric {
    ...
    align-items: center;
    gap: calc(var(--layout-spacing_unit) * 0.5);
  }

  .performance-overlay .label {
    opacity: 0.7;
    font-size: var(--typography-font_size_xs, 11px);
  ...
  .instructions {
    position: fixed;
    bottom: calc(var(--layout-spacing_unit) * 2.5);
    left: calc(var(--layout-spacing_unit) * 2.5);
    background: var(--color-background_tertiary);
    border: 1px solid var(--color-border, #333);
    border-radius: var(--layout-border_radius);
    padding: calc(var(--layout-spacing_unit) * 2.5);
    max-width: 400px;
    z-index: 100;
  }
  ...
  .instructions h2 {
    font-size: var(--typography-font_size_lg);
    margin: 0 0 calc(var(--layout-spacing_unit) * 1.5) 0;
  }
